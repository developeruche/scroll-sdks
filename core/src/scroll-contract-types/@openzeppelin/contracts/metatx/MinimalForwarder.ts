...
export interface MinimalForwarderInterface extends Interface {
  getFunction(
...
export interface MinimalForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): MinimalForwarder;
  ...
  execute: TypedContractMethod<
    [req: MinimalForwarder.ForwardRequestStruct, signature: BytesLike],
    [[boolean, string]],
    "payable"
  >;
