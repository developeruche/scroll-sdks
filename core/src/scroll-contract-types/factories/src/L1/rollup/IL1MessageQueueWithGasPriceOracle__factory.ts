...
import type {
  ...
  IL1MessageQueueWithGasPriceOracleInterface,
} from "../../../../src/L1/rollup/IL1MessageQueueWithGasPriceOracle";
...
export class IL1MessageQueueWithGasPriceOracle__factory {
  static readonly abi = _abi;
  static createInterface(): IL1MessageQueueWithGasPriceOracleInterface {
    return new Interface(_abi) as IL1MessageQueueWithGasPriceOracleInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IL1MessageQueueWithGasPriceOracle;
  }
}
