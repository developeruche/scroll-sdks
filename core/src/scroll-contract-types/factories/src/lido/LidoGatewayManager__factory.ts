...
import type {
  LidoGatewayManager,
  LidoGatewayManagerInterface,
} from "../../../src/lido/LidoGatewayManager";
...
export class LidoGatewayManager__factory {
  static readonly abi = _abi;
  static createInterface(): LidoGatewayManagerInterface {
    return new Interface(_abi) as LidoGatewayManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LidoGatewayManager {
    return new Contract(address, _abi, runner) as unknown as LidoGatewayManager;
  }
}
