...
export interface L1StandardERC20GatewayInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "counterpart"
  ...
  encodeFunctionData(
    functionFragment: "l2TokenImplementation",
    values?: undefined
  ): string;
...
export interface L1StandardERC20Gateway extends BaseContract {
  connect(runner?: ContractRunner | null): L1StandardERC20Gateway;
  waitForDeployment(): Promise<this>;

  interface: L1StandardERC20GatewayInterface;
  ...
  l2TokenFactory: TypedContractMethod<[], [string], "view">;

  l2TokenImplementation: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "l2TokenFactory"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "l2TokenImplementation"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
