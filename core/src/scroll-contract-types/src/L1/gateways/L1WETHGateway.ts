...
export interface L1WETHGatewayInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "counterpart"
...
export interface L1WETHGateway extends BaseContract {
  connect(runner?: ContractRunner | null): L1WETHGateway;
  ...
  l2WETH: TypedContractMethod<[], [string], "view">;
