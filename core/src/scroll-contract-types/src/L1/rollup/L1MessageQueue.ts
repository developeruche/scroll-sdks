...
export interface L1MessageQueueInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface L1MessageQueue extends BaseContract {
  connect(runner?: ContractRunner | null): L1MessageQueue;
  waitForDeployment(): Promise<this>;

  interface: L1MessageQueueInterface;
