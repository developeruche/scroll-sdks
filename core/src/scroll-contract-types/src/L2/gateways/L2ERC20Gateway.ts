...
export interface L2ERC20GatewayInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "counterpart"
...
export interface L2ERC20Gateway extends BaseContract {
  connect(runner?: ContractRunner | null): L2ERC20Gateway;
