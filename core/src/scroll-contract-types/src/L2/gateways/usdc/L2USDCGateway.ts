...
export interface L2USDCGatewayInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "circleCaller"
      | "counterpart"
...
export interface L2USDCGateway extends BaseContract {
  connect(runner?: ContractRunner | null): L2USDCGateway;
  waitForDeployment(): Promise<this>;

  interface: L2USDCGatewayInterface;
