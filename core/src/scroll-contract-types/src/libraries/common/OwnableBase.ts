...
export interface OwnableBaseInterface extends Interface {
  getFunction(
...
export interface OwnableBase extends BaseContract {
  connect(runner?: ContractRunner | null): OwnableBase;
  waitForDeployment(): Promise<this>;

  interface: OwnableBaseInterface;
