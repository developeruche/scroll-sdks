...
export interface IScrollERC20ExtensionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "counterpart"
...
export interface IScrollERC20Extension extends BaseContract {
  connect(runner?: ContractRunner | null): IScrollERC20Extension;
  waitForDeployment(): Promise<this>;

  interface: IScrollERC20ExtensionInterface;
