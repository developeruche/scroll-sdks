...
export interface IScrollERC721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IScrollERC721 extends BaseContract {
  connect(runner?: ContractRunner | null): IScrollERC721;
  waitForDeployment(): Promise<this>;

  interface: IScrollERC721Interface;
