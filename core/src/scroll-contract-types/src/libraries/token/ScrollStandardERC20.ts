...
export interface ScrollStandardERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface ScrollStandardERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): ScrollStandardERC20;
  waitForDeployment(): Promise<this>;

  interface: ScrollStandardERC20Interface;
