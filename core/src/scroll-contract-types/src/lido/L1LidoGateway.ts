...
export interface L1LidoGatewayInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface L1LidoGateway extends BaseContract {
  connect(runner?: ContractRunner | null): L1LidoGateway;
  waitForDeployment(): Promise<this>;

  interface: L1LidoGatewayInterface;
  ...
  initializeV2: TypedContractMethod<
    [
      _depositsEnabler: AddressLike,
      _depositsDisabler: AddressLike,
      _withdrawalsEnabler: AddressLike,
      _withdrawalsDisabler: AddressLike
    ],
    [void],
    "nonpayable"
  >;
