...
import type {
  IL1MessageQueue,
  IL1MessageQueueInterface,
} from "../../../../src/L1/rollup/IL1MessageQueue";
...
export class IL1MessageQueue__factory {
  static readonly abi = _abi;
  static createInterface(): IL1MessageQueueInterface {
    return new Interface(_abi) as IL1MessageQueueInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IL1MessageQueue {
    return new Contract(address, _abi, runner) as unknown as IL1MessageQueue;
  }
}
