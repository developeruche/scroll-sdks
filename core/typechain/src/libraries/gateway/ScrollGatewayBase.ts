...
export interface ScrollGatewayBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "counterpart"
      | "messenger"
...
export interface ScrollGatewayBase extends BaseContract {
  connect(runner?: ContractRunner | null): ScrollGatewayBase;
  waitForDeployment(): Promise<this>;

  interface: ScrollGatewayBaseInterface;
