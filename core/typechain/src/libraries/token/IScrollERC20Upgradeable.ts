...
export interface IScrollERC20UpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface IScrollERC20Upgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): IScrollERC20Upgradeable;
  waitForDeployment(): Promise<this>;

  interface: IScrollERC20UpgradeableInterface;
