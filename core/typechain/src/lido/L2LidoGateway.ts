...
export interface L2LidoGatewayInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface L2LidoGateway extends BaseContract {
  connect(runner?: ContractRunner | null): L2LidoGateway;
  waitForDeployment(): Promise<this>;

  interface: L2LidoGatewayInterface;
