...
export interface TokenRateLimiterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "TOKEN_SPENDER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "TOKEN_SPENDER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TokenRateLimiter extends BaseContract {
  connect(runner?: ContractRunner | null): TokenRateLimiter;
  waitForDeployment(): Promise<this>;

  interface: TokenRateLimiterInterface;
  ...
  TOKEN_SPENDER_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  updateTotalLimit: TypedContractMethod<
    [_token: AddressLike, _newTotalLimit: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "TOKEN_SPENDER_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
